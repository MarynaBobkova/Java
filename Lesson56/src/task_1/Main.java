...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("Подставляем строку - %.6s - строка подставлена.%n", hello);
        ...
        System.out.printf("Число Пи округленное равно %.3f.%n", pi);
        ...
        System.out.printf("Сегодня %1$td %1$tB %1$tY года, время - %1$tH часов, %1$tM минут.%n", date);
